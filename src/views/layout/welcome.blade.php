...
<html>
    <head>
        ...
        <!--theme-style-->
        <link href="{{('product/css/style4.css')}}" rel="stylesheet" type="text/css" media="all" />
        <!--//theme-style-->
        <script src="{{('product/js/jquery.min.js')}}"></script>
        <!--- start-rate---->
        <script src="{{('product/js/jstarbox.js')}}"></script>
...
<!--banner-->
    ...
    <!--light-box-files -->
    <script src="{{('product/js/jquery.chocolat.js')}}"></script>
