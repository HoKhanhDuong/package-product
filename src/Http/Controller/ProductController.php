...
use Duong\Product\Models\Product_Type;
use Duong\Product\Models\Images;
use Duong\Product\Models\PK_Product;
...
class ProductController extends Controller
{
    ...
    protected PK_Product $pk_prod;

    public function __construct(Products $product, Product_Type $product_type, 
    Accessories_PK $ac_pk, Images $image, PK_Product $pk_prod)
    {
    ...
    public function getAddProduct() {
        ...
        return view('product::page.add_product',
            [
                'pro_types' => $pro_types,
                'phu_kiens' => $phu_kiens,
            ]);
    ...
    public function getEditProduct(Request $req) {
        ...
        return view('product::page.edit_product',[
            'product' => $product,
            'pro_types' => $pro_types,
            'phu_kiens' => $phu_kiens,
        ]);
